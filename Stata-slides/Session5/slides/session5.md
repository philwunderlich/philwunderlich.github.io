...
- Most things graphs can show, could also be shown in numbers or tables. But: Graphs are often easier to read <!-- .element: class="fragment" data-fragment-index="1" -->
- Visualizing <!-- .element: class="fragment" data-fragment-index="2" --> **frequencies** <!-- .element: class="fragment" data-fragment-index="2" --> and **proportions**. <!-- .element: class="fragment" data-fragment-index="2" -->
...
- Visualizing <!-- .element: class="fragment" data-fragment-index="2" -->**distributions** <!-- .element: class="fragment" data-fragment-index="2" -->
...
- Visualizing<<!-- .element: class="fragment" data-fragment-index="2" --> **relationships** <!-- .element: class="fragment" data-fragment-index="2" --> between two or more variables (We will see this in 5.2). <!-- .element: class="fragment" data-fragment-index="2" -->
...
- Histograms give us a very intuitive overview over the distribution of values.<!-- .element: class="fragment" -->
- They draw bars representing how often a certain value or range of values is present in the data.<!-- .element: class="fragment" -->
...
- by default, STATA plots <!-- .element class="fragment" data-fragment-index="1"--> **density** <!-- .element class="fragment" data-fragment-index="1"--> histograms, meaning that all columns would add up to a total of 1.0.
...
(bin=35, start=18, width=2.0857143)
```
![](img/hist_age.svg) <!-- .element: width="650" -->
</div>
...
![](../stata_wd/output/hist_meanline.svg)<!-- .element: width="650" -->
